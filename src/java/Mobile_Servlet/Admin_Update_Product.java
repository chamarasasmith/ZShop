 ...
 * @author chama
 */
public class Admin_Update_Product extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (o instanceof HashMap) {
                ...
                c4.add(Restrictions.eq("idproducts", Integer.parseInt(pid)));
                Products p1 = (Products) c4.uniqueResult();

                Criteria c5 = s1.createCriteria(Category.class);
                c5.add(Restrictions.eq("idcategory", Integer.parseInt(cat.split(" - ")[0].toString())));
                Category c1 = (Category) c5.uniqueResult();

                Criteria c6 = s1.createCriteria(Brand.class);
                c6.add(Restrictions.eq("idbrand", Integer.parseInt(brand.split(" - ")[0].toString())));
                Brand b1 = (Brand) c6.uniqueResult();
