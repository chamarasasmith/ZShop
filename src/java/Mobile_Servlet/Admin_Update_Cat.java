 ...
 * @author chama
 */
public class Admin_Update_Cat extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (o instanceof HashMap) {
                ...
                String cid = hm.get("cid").toString();
                String bname = hm.get("cname").toString();

                Criteria c4 = s1.createCriteria(Category.class);
                c4.add(Restrictions.eq("idcategory", Integer.parseInt(cid)));
                Category c1 = (Category) c4.uniqueResult();
