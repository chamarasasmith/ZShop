            ...
            try {
                ...
                for (Object o : list) {
                    ...
                    if (fileItem.isFormField()) {
                        ...
                        if (fileItem.getFieldName().equals("uppid")) {
                            String t1 = fileItem.getString().trim();
                            if (!t1.isEmpty()) {
                                i1++;
                                Criteria c4 = s1.createCriteria(Products.class);
                                c4.add(Restrictions.eq("idproducts", Integer.parseInt(t1)));
                                p = (Products) c4.uniqueResult();
                            }
                        }

                        if (fileItem.getFieldName().equals("pname2")) {
                            String t1 = fileItem.getString().trim();
                            if (!t1.isEmpty()) {
                                i1++;
                        ...
                        if (fileItem.getFieldName().equals("brname2")) {
                        ...
                        if (fileItem.getFieldName().equals("cp2")) {
                        ...
                        if (fileItem.getFieldName().equals("pdes2")) {
                            p.setDes(fileItem.getString());
                        }
                        if (fileItem.getFieldName().equals("pcat2")) {
                            String t1 = fileItem.getString().split(" : ")[0];
                            boolean isNumeric = t1.chars().allMatch(Character::isDigit);
                            if (isNumeric) {
                                i1++;
                        ...
                        if (fileItem.getFieldName().equals("pqty2")) {
                            String t1 = fileItem.getString();
                            boolean isNumeric = t1.chars().allMatch(Character::isDigit);
                            if (isNumeric) {
                                i1++;
                        ...
                        if (fileItem.getFieldName().equals("psp2")) {
                            String t1 = fileItem.getString();
                            boolean isNumeric = t1.chars().allMatch(Character::isDigit);
                            if (isNumeric) {
                                i1++;
                        ...
                        if (fileItem.getFieldName().equals("pmin2")) {
                            String t1 = fileItem.getString();
                            boolean isNumeric = t1.chars().allMatch(Character::isDigit);
                            if (isNumeric) {
                                i1++;
                        ...
                        if (fileItem.getFieldName().equals("proimg2")) {
                            String thumb = "";
