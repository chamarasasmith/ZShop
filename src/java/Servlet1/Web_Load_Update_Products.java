 ...
 * @author chama
 */
public class Web_Load_Update_Products extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                obj.put("cat", p.getCategory().getIdcategory());
                obj.put("bname", p.getBrand().getIdbrand());
                obj.put("img1", p.getMimg());

                request.setAttribute("jp", obj);

                RequestDispatcher rd = request.getRequestDispatcher("admin/products/UpdateView.jsp");
