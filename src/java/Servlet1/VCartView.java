 ...
 * @author chama
 */
public class VCartView extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (u != null) {
                    ...
                    int uid = Integer.parseInt(u.toString());

                    Criteria c3 = s1.createCriteria(User.class);
                    c3.add(Restrictions.eq("iduser", uid));
                ...
                RequestDispatcher rd = request.getRequestDispatcher("sub/vcartview.jsp");
