            ...
            <table class="table table-responsive text-center">
                ...
                <tr>
                    ...
                    <td><% 
                        ...
                        %></td>
                    <td><button class="btn btn-info" onclick="changeStatus('5','admin/orders/ViewApproved.jsp','3','o','<%=p3.getIdinvoice().toString() %>')">Delivery</button></td>
                    <td><button class="btn btn-danger" onclick="changeStatus('5','admin/orders/ViewApproved.jsp','1','o','<%=p3.getIdinvoice().toString() %>')">Undo</button></td>
                </tr>
                <%
                        }
                    }
